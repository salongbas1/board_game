...
function pointBuyCostOf(score) {
  ...
  if (s <= POINT_BUY_COST_MAX_DEFINED) {
    return POINT_BUY_COST[s] !== undefined ? POINT_BUY_COST[s] : Infinity;
  }
  return POINT_BUY_COST[POINT_BUY_COST_MAX_DEFINED] + (s - POINT_BUY_COST_MAX_DEFINED) * POINT_BUY_COST_PER_STEP_ABOVE_MAX;
}
